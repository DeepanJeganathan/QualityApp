...
namespace LabourReporting.Controllers
{
    public class OperatorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OperatorID,FirstName,LastName")] Operator @operator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OperatorID,FirstName,LastName")] Operator @operator)
        {
